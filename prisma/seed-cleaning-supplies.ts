...
async function main() {
  console.log('Starting database seed with Hyper Cleaning Supplies data...');
  ...
  // Create cleaning supply products
  const productsData = [
    {
  ...
  await prisma.user.upsert({
    where: { email: process.env.ADMIN_EMAIL || 'admin@hypercleaning.com' },
    update: {},
    create: {
  ...
  console.log('✅ Database seeded successfully with Hyper Cleaning Supplies data!');
  console.log('Admin credentials: admin@hypercleaning.com / HyperClean@2024$Admin!');
