      ...
      <div className="max-w-frame mx-auto px-4 xl:px-0 py-12">
        <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="sticky top-24 bg-gray-50 rounded-2xl p-6">
              ...
              <nav className="space-y-2">
                {["Introduction", "Orders & Payment", "Pricing", "Delivery", "Returns", "Liability", "Contact"].map((item, idx) => (
                  <a key={idx} href={`#section-${idx + 1}`} className="block text-sm text-gray-600 hover:text-red-700 py-1 transition-colors">
                    {idx + 1}. {item}
                  </a>
                ))}
              </nav>
          ...
          <div className="lg:col-span-3 space-y-8">
            <p className="text-sm text-gray-500 bg-red-50 border border-sky-200 rounded-lg p-4">
            ...
            <section id="section-4" className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <Link href="/delivery" className="inline-flex items-center gap-2 mt-4 text-red-700 hover:text-red-800 font-medium">
            ...
            <section id="section-5" className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <Link href="/returns" className="inline-flex items-center gap-2 mt-4 text-red-700 hover:text-red-800 font-medium">
                    View returns policy
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
            ...
            <section id="section-7" className="bg-gradient-to-r from-sky-500 to-sky-600 rounded-2xl p-8 text-white">
              ...
              <Link href="/contact" className="inline-flex items-center gap-2 bg-white text-red-700 px-6 py-3 rounded-full font-medium hover:bg-red-50 transition-colors">
                Contact Us
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
