        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <section className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
              ...
              <div className="bg-red-50 rounded-xl p-6 border border-sky-100">
            ...
            <section className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-red-50 rounded-xl p-5 border border-sky-100">
            ...
            <section className="bg-gradient-to-r from-sky-500 to-sky-600 rounded-2xl p-8 text-white">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <Link href="/contact" className="inline-flex items-center gap-2 bg-white text-red-700 px-5 py-2 rounded-full text-sm font-semibold hover:bg-red-50 transition-colors">
                    Report Damage
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-gradient-to-br from-sky-500 to-sky-600 rounded-2xl p-6 text-white">
                ...
                <Link href="/contact" className="inline-flex items-center gap-2 bg-white text-red-700 px-4 py-2 rounded-full text-sm font-medium hover:bg-red-50 transition-colors w-full justify-center">
                  Contact Support
                </Link>
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <svg className="w-4 h-4 text-red-700 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                ...
                <nav className="space-y-2">
                  ...
                  <Link href="/delivery" className="flex items-center gap-2 text-gray-600 hover:text-red-700 py-2 transition-colors">
                    <span>🚚</span> Delivery Info
                  </Link>
                  <Link href="/contact" className="flex items-center gap-2 text-gray-600 hover:text-red-700 py-2 transition-colors">
