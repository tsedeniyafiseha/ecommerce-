    ...
    <section>
      <div className="flex items-center justify-between flex-col sm:flex-row mb-5 sm:mb-6">
        ...
        <div className="flex items-center space-x-2.5">
          ...
          <Button
            type="button"
            className="sm:min-w-[166px] px-4 py-3 sm:px-5 sm:py-4 rounded-full bg-red-700 hover:bg-red-800 font-medium text-xs sm:text-base h-12"
          >
            Write a Review
          </Button>
        </div>
      ...
      <div className="w-full px-4 sm:px-0 text-center">
        <Link
          href="#"
          className="inline-block w-[230px] px-11 py-4 border rounded-full hover:bg-red-700 hover:text-white hover:border-red-700 text-black transition-all font-medium text-sm sm:text-base border-black/10"
        >
          Load More Reviews
        </Link>
      </div>
